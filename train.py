...
learning_rate = 1e-5 # 学习率 对应batchsize修改
only_mid_control = True # 标志位，可能用于控制模型中间层的行为
data_path = './training/MVTec-AD/mvtec_anomaly_detection/' # 数据集存放的根目录
...
# tb_logger = TensorBoardLogger(save_dir="lightning_logs", name="mvtecAD")
